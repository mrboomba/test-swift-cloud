...
const PopularContainer = () => {
  const june = useGetPopularSongsQuery({
    variables: { orderBy: { PlaysJune: SortOrder.Desc }, skip: 0, take: 10 },
  });
  const july = useGetPopularSongsQuery({
    variables: { orderBy: { PlaysJuly: SortOrder.Desc }, skip: 0, take: 10 },
  });
  const august = useGetPopularSongsQuery({
    variables: { orderBy: { PlaysAugust: SortOrder.Desc }, skip: 0, take: 10 },
  });
